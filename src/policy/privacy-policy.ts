    ...
    sections: [
        ...
        table: {
          ...
          rows: [
            ...
            [
              '광고 보상',
              '광고 보상 거래 번호, 지급한 날짜',
              '광고를 끝까지 본 뒤 Google(AdMob)이 보내는 확인 요청으로 받음',
            ],
            [
              '알림',
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              '「전자상거래 등에서의 소비자보호에 관한 법률」에 따라 5년. 탈퇴하면 회원과의 연결만 끊고 보관합니다.',
            ],
            [
              '탈퇴한 계정 식별자의 해시값',
            ...
            [
              '서버 로그',
              '서비스마다 10MB씩 최대 5개 파일까지 두고, 넘으면 오래된 것부터 지웁니다.',
            ],
            [
              '데이터베이스 백업',
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              'Google LLC (AdMob)',
              '광고 표시와 광고 보상 확인',
              '운영자 서버는 Google이 보내는 보상 확인 요청(회원 식별 번호, 거래 번호)을 받고, 서명 확인용 공개키만 조회합니다.',
              '미국 · 광고 보상을 받을 때',
            ],
          ],
        },
        notes: [
          ...
          '앱에 광고를 연동하면 앱에 들어간 Google AdMob SDK가 기기·광고 관련 정보를 Google에 보낼 수 있습니다. 연동할 때 보내는 항목을 이 방침에 추가합니다.',
        ],
      },
      {
        id: 'destruction',
      ...
      },
      {
        ...
        items: [
          ...
          '만 14세 미만 아동의 법정대리인도 위 권리를 행사할 수 있습니다.',
        ],
      },
      {
        id: 'security',
      ...
      },
      {
        ...
        paragraphs: [
          '이 처리방침을 바꾸면 시행하기 전에 이 페이지와 앱을 통해 알립니다. 이용자의 권리에 중요한 변경이 있으면 더 일찍 알립니다.',
